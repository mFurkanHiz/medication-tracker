export const messages = {
  tr: {
    ...
    login: 'Giriş yap', register: 'Hesap oluştur', email: 'E-posta', password: 'Parola', confirmPassword: 'Parola tekrarı (en az 12 karakter)', passwordMismatch: 'Parolalar eşleşmiyor.', logout: 'Çıkış yap', loginError: 'Giriş yapılamadı. Bilgilerinizi ve bağlantınızı kontrol edin.',
  ...
  en: {
    ...
    login: 'Sign in', register: 'Create account', email: 'Email', password: 'Password', confirmPassword: 'Confirm password (at least 12 characters)', passwordMismatch: 'Passwords do not match.', logout: 'Sign out', loginError: 'Unable to sign in. Check your credentials and connection.',
