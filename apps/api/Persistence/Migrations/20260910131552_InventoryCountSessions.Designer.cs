...
namespace MedicationTracker.Api.Persistence.Migrations
{
    ...
    [Migration("20260910131552_InventoryCountSessions")]
    partial class InventoryCountSessions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicationTracker.Api.Modules.Care.RegimenVersion", b =>
                {
                    ...
                    b.HasIndex("RegimenId", "ValidFrom")
                        .IsUnique();
                    ...
                    b.ToTable("regimen_versions", "treatments", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_regimen_versions_period", "valid_to IS NULL OR valid_to >= valid_from");
                        });
                });
            ...
            modelBuilder.Entity("MedicationTracker.Api.Modules.Identity.AccountSession", b =>
                {
            ...
            modelBuilder.Entity("MedicationTracker.Api.Modules.Care.InventoryLedgerEntry", b =>
                {
                    b.HasOne("MedicationTracker.Api.Modules.Care.AdministrationEvent", null)
                        .WithOne()
                        .HasForeignKey("MedicationTracker.Api.Modules.Care.InventoryLedgerEntry", "AdministrationEventId")
                        .OnDelete(DeleteBehavior.Restrict);
