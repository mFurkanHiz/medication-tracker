export const messages = {
  tr: {
    title: 'Medication Tracker', description: 'İlaç düzeni ve stok takibi', eyebrow: 'İlk sürüm · Sentetik demo',
  ...
  en: {
    title: 'Medication Tracker', description: 'Medication routine and inventory tracking', eyebrow: 'First release · Synthetic demo',
